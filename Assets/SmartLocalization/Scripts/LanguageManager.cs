...
public class LanguageManager : Singleton<LanguageManager>
{
    ...
    void Awake()
    {
        ...
        Logger.Log("LanguageManager.cs: Waking up");
    ...
    private void LoadResources()
    {
        ...
        if (!languageDocument && defaultLanguage != language)
        {
            ...
            Logger.LogError("ERROR: Language file:" + language + " could not be found! - reverting to default language:" + defaultLanguage);
            ChangeLanguage(defaultLanguage);
            return;
        }
        else if (!languageDocument)
        {
            Logger.LogError("ERROR: Language file:" + language + " could not be found!");
            return;
        }
    ...
    public string GetTextValue(string key)
    {
        ...
        Logger.LogError("LanguageManager.cs: Invalid Key:" + key + "for language: " + language);
        return null;
    }
    /// <summary>
    ...
    public string GetSystemLanguage()
    {
        ...
        {
            Logger.LogWarning("LanguageManager.cs: The system language of this application is Unknown");
            return "Unknown";
        }
        ...
        Logger.LogError("LanguageManager.cs: A system language of this application is could not be found!");
