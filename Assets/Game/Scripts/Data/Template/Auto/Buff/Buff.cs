...
namespace Template.Auto.Buff
{
  ...
  [Serializable]
  #endif
  public partial class Buff : TBase
  {
    private Dictionary<int, BattleBuffTemplate> _battleBuffTmpls;

    public Dictionary<int, BattleBuffTemplate> BattleBuffTmpls
    {
      get
      {
        return _battleBuffTmpls;
      }
      set
      {
        __isset.battleBuffTmpls = true;
        this._battleBuffTmpls = value;
      }
    }
