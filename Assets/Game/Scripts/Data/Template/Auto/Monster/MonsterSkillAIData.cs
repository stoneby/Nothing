...
namespace Template.Auto.Monster
{
  ...
  [Serializable]
  #endif
  public partial class MonsterSkillAIData : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MonsterSkillAIData");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MonsterSkillAIData(");
      sb.Append("SkillId: ");
      sb.Append(SkillId);
      sb.Append(",Weight: ");
      sb.Append(Weight);
