...
namespace Template.Auto.Bag
{
  ...
  [Serializable]
  #endif
  public partial class BagItemExtendCostTemplate : TBase
  {
    private int _id;
    ...
    public BagItemExtendCostTemplate() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("BagItemExtendCostTemplate");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("BagItemExtendCostTemplate(");
      sb.Append("Id: ");
      sb.Append(Id);
