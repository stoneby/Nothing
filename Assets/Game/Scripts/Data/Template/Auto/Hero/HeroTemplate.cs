...
namespace Template.Auto.Hero
{
  ...
  public partial class HeroTemplate : TBase
  {
    ...
    private List<int> _passiveSkill;
    ...
    public void Write(TProtocol oprot) {
      ...
      if (PassiveSkill != null && __isset.passiveSkill) {
        field.Name = "passiveSkill";
        field.Type = TType.List;
        field.ID = 27;
        oprot.WriteFieldBegin(field);
        {
          oprot.WriteListBegin(new TList(TType.I32, PassiveSkill.Count));
          foreach (int _iter3 in PassiveSkill)
          {
