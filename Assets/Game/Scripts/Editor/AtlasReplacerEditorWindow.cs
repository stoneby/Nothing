...
public class AtlasReplacerEditorWindow : EditorWindow
{
    ...
    private static void AddWindow()
    {
        ...
        var window =
            (AtlasReplacerEditorWindow)GetWindowWithRect(typeof(AtlasReplacerEditorWindow), wr, true, "Altas Replacer");
        window.Show();
    }
