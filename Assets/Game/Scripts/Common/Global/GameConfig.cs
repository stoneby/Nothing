...
public class GameConfig
{
    ...
    public static float ShortTime = 0.01f;               //最小的时间片段
    public static float PlayAttrackTime = 0.4f;          //回血时攻击动画所用的时间
    public static float RunStepNeedTime = 0.2f;          //跑位所需的单位时间（可用于计算速度）
    public static float NextRunWaitTime = 0.15f;         //两个人之间的间隔时间
