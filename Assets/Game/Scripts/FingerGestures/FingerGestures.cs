...
public class FingerGestures : MonoBehaviour
{
    ...
    public void InstallInputProvider( FGInputProvider inputProviderPrefab )
    {
        ...
        {
            Logger.LogError( "Invalid InputProvider (null)" );
            return;
        }

        Logger.Log( "FingerGestures: using " + inputProviderPrefab.name );
    ...
    public static void Register( GestureRecognizer recognizer )
    {
        ...
        //Logger.Log( "Registered gesture recognizer: " + recognizer );
    }
    ...
    void CheckInit()
    {
        ...
        {
            Logger.LogWarning( "There is already an instance of FingerGestures created (" + instance.name + "). Destroying new one." );
    ...
    void Update()
    {
        ...
        {
            Logger.Log( "UnityRemote presence detected. Switching to touch input." );
