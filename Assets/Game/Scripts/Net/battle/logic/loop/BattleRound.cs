namespace com.kx.sglm.gs.battle.share.logic.loop
{
	...
	/// <summary>
	/// 处理一个回合，即战斗内所有BattleTeam的一次完整出手�?这里会产生出手挂起�?挂起由{@link IBattleExecuter}触发�?
	/// 出手结束后，若未死亡，则直接进入下一个回合，如果产生死亡，通知<seealso cref="BattleScene"/>是否需要切�?
	/// 
	/// @author liyuan2
	/// 
	/// </summary>
