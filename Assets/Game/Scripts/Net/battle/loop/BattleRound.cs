...
//ORIGINAL LINE: final com.kx.sglm.gs.battle.actor.impl.BattleTeam _attackerTeam = getCurAttacker().getCurActor();
			BattleTeam _attackerTeam = CurAttacker.CurActor;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final com.kx.sglm.gs.battle.actor.impl.BattleTeam _defencerTeam = getCurAttacker().getOppositeTeam(_attackerTeam);
