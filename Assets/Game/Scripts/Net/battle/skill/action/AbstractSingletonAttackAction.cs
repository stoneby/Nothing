...
namespace com.kx.sglm.gs.battle.share.skill.action
{
	...
	/// </summary>
	[Obsolete]
	public abstract class AbstractSingletonAttackAction : ISingletonSkillAction
	{
		public abstract bool canOption(BattleFighter attacker);
		public abstract void onAction(BattleFighter attacker, BattleFightRecord record);
...
//ORIGINAL LINE: final int _targetIndex = _attackerTeam.getIntProp((com.kx.sglm.gs.battle.share.BattleKeyConstants.BATTLE_KEY_HERO_TEAM_TARGET));
		...
		public virtual List<ISkillCondition> ConditionList
		{
			get
			{
				return com.kx.sglm.gs.battle.share.skill.ISingletonSkillAction_Fields.emptyList;
			}
		}
		...
		public abstract List<BattleFighter> getDefencerList(BattleFighter attacker, BattleTeam defencerTeam);
