...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class CSFriendQueryByName : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CSFriendQueryByName");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CSFriendQueryByName(");
