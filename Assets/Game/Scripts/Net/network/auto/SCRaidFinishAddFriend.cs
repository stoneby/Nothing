...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class SCRaidFinishAddFriend : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCRaidFinishAddFriend");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCRaidFinishAddFriend(");
