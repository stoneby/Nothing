...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class CSFriendGiveEnergy : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CSFriendGiveEnergy");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CSFriendGiveEnergy(");
