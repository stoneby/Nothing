...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class CSFriendRecieveEnergy : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CSFriendRecieveEnergy");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CSFriendRecieveEnergy(");
