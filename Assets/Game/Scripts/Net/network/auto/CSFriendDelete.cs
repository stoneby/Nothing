...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class CSFriendDelete : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CSFriendDelete");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CSFriendDelete(");
