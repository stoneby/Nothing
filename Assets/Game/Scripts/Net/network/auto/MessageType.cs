...
namespace KXSGCodec
{
  public enum MessageType
  {
    ...
    CS_SIGN = 157,
    CS_QUEST = 158,
    CS_QUEST_RECIEVE_REWARD = 159,
    CS_MAIL_UNREAD_STATE_MSG = 160,
    CS_END = 161,
    SC_BEGIN = 2000,
    ...
    SC_SIGN_LOAD = 2069,
    SC_SIGN_SUCC = 2070,
    SC_SIGN_REFRESH = 2071,
    SC_QUEST = 2072,
    SC_QUEST_RECIEVE_REWARD_SUCC = 2073,
    SC_QUEST_FINISH = 2074,
    SC_MAIL_UNREAD_STATE_MSG = 2075,
    SC_END = 2076,
  }
}
