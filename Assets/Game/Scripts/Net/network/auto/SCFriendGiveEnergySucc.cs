...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class SCFriendGiveEnergySucc : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCFriendGiveEnergySucc");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCFriendGiveEnergySucc(");
