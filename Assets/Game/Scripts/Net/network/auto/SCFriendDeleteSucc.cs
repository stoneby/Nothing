...
namespace KXSGCodec
{
  ...
  [Serializable]
  #endif
  public partial class SCFriendDeleteSucc : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCFriendDeleteSucc");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCFriendDeleteSucc(");
