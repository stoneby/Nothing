            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  KXSGCodec.TeamInfo _elem2 = new KXSGCodec.TeamInfo();
                  _elem2 = new KXSGCodec.TeamInfo();
                  _elem2.Read(iprot);
                  TeamList.Add(_elem2);
                }
                iprot.ReadListEnd();
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  KXSGCodec.HeroInfo _elem5 = new KXSGCodec.HeroInfo();
                  _elem5 = new KXSGCodec.HeroInfo();
                  _elem5.Read(iprot);
                  HeroList.Add(_elem5);
                }
                iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      if (TeamList != null && __isset.teamList) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (KXSGCodec.TeamInfo _iter6 in TeamList)
          {
            _iter6.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (HeroList != null && __isset.heroList) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (KXSGCodec.HeroInfo _iter7 in HeroList)
          {
            _iter7.Write(oprot);
          }
          oprot.WriteListEnd();
